class MaximumPriorityQueue {
    ...
    System.out.println("Original heap");
      ...
      System.out.println("\nHeap after increasing the key of 5th index to 22\n");
      increaseKey(A, 5, 22);
      printHeap(A);
      System.out.println("\nHeap after decreasing the key of 1st index to 13\n");
      decreaseKey(A, 1, 13);
      printHeap(A);
  
      System.out.println("\nMaximum priorty in the current Heap is :"+maximum(A));
      System.out.println("");
      System.out.println(extractMax(A));
      System.out.println("");
  
      System.out.println("Heap after removing the maximum value");
      printHeap(A);
